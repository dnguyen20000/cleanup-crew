...
export const SEVERITY = {
  high: { color: '#ef3b2d', label: 'High', pill: 'red', multiplier: 3 },
  medium: { color: '#f0762b', label: 'Medium', pill: 'orange', multiplier: 2 },
  low: { color: '#2fae7a', label: 'Low', pill: 'green', multiplier: 1 }
}
